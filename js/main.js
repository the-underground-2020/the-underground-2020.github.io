...
firetable.init = function() {
  ...
  var config = {
    apiKey: "AIzaSyCRNkmRf2AOSLCncgpOGpUce-iUB8Q77l8",
    authDomain: "underground-the.firebaseapp.com",
    databaseURL: "https://underground-the.firebaseio.com"
  };
...
firetable.actions = {
  ...
  displayCard: function(data, chatid){
    ...
    if (canvas.getContext) {
      ...
      ctx.fillText("Printed "+firetable.utilities.format_date(data.date)+" | The Underground", 112.5, 299);
    ...
    if (link.match(/youtube.com\/watch/)) {
      ...
      if (therealid) {
        function keyWordsearch() {
          gapi.client.setApiKey('AIzaSyAtDmGKSNchQwEIpYolJVagVVDVq2hKUa0');
